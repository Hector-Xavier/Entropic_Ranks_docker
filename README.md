...
**granularity** - The sliding window step, corresponding to the granularity of the partitioning process (e.g. feature-by-feature, or partitioning by 5-feature steps). May be used to speed up analysis and/or verify convergence. > default value: 1
